                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50/50 border-b border-slate-100">
                                <th className="px-4 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Customer Details</th>
                                ...
                                <th className="px-4 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">CRM Follow Up</th>
                                    ...
                                    <tr key={customer.id} className="hover:bg-slate-50/80 transition-colors group">
                                        <td className="px-4 py-3">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div className="font-medium text-slate-900 text-sm">{customer.customer_name}</div>
                                                    <div className="text-xs text-slate-500 flex items-center gap-1">
                                                        <MapPin size={12} /> {customer.location || 'N/A'}
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-4 py-3">
                                            <div className="text-sm font-mono text-slate-700">{customer.gst_number || 'N/A'}</div>
                                        </td>
                                        <td className="px-4 py-3">
                                            <div className="text-xs text-slate-500 italic truncate max-w-[150px]">{customer.crm_follow_up || 'No follow up'}</div>
                                        </td>
